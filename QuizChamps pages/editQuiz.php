...
<nav class="navbar navbar-inverse navbar-fixed-top">
	...
	<h1>Find a quiz to edit/delete</h1>
  <form name="editQuiz" method="post" action="editQuiz.php" 
...
<?php
  ...
  $dbQuery="SELECT quiz_title FROM quiz";
  $dbResult=mysql_query($dbQuery);
  ...
  while ($dbRow=mysql_fetch_array($dbResult)) {
     ...
     echo "<option name = '$count' value = '$theQuiz 'maxlength='1000'>$theQuiz</option><br>";
...
?>
  ...
  <input type="submit" value="Select this Quiz">
